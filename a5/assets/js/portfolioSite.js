...
$(document).ready(function(){
	...
	$("div").css("background-image", "url(" + imagePath + "sunset2.jpg" + ")");
	...
	$("div").mouseover(function(){
		...
		$("div").css("background-image", "url(" + imagePath + hoverImages[trackStop] + ")");
		}
	...
	$("div").mouseleave(function(){
		//To avoid changing to next site images before next button is clicked
		if(trackStop<currentStop&& goAgain==true){
		$("div").css("background-image", "url(" + imagePath + imageOrder[trackStop] + ")");
		}
	});
